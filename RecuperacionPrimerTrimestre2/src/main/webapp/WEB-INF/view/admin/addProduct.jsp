		...
		<div class="row justify-content-center mt-3">
			<div class="col-6">
				<form method="post">
					...
					<label for="customerName" class="form-label mt-3">Product Name</label>
    				<input type="text" class="form-control" id="productName" name="productName" required >	
    				
    				<label for="amount" class="form-label mt-3">Product Line</label>
    				...
    				<label for="paymentDate" class="form-label mt-3">Prodcut Scale</label>
    				...
    				<input type="int" class="form-control" id="buyPrice" name="buyPrice" required>
    				
    				<label for="amount" class="form-label mt-3">MSRP</label>
    				<input type="int" class="form-control" id="msrp" name="msrp" required>
